    ...
    <div class="row intro-text">
      <div class="col-md-8 col-md-offset-2 text-center">
        <div class="probootstrap-testimonial" align="center">
          <form align="center" action="registerkan" method="POST" class="probootstrap-form" enctype="multipart/form-data">
            <h2 class="text-black mt0">Register</h2>
            ...
            <div class="form-group">
              <p class="mb0"><input type="phone" class="form-control" name="phone" placeholder="Phone" required></p>
            </div>
            <div class="form-group">
              <p class="mb0"><input type="email" class="form-control" name="email" placeholder="Email" required></p>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <a href="<?php echo base_url()?>index.php/login/login" class="btn btn-default smoothscroll">Login</a>
            </div>
          </form>
        </div>
      </div>
