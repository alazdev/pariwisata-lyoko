  ...
  <div class="container">
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="<?php echo base_url().'index.php/login/logout';?>" onclick="leave()">Logout</a></li>
      </ul>
    </div>
  </div>
</nav>
  ...
  <div class="container">
    <div class="row intro-text">
      <div class="col-md-8 col-md-offset-2 text-center">
        <h1 class="probootstrap-heading probootstrap-animate">Hai Selamat Datang <em>Admin</em></h1>
